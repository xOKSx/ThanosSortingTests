...
/**
 * Класс, содержащий набор сцентариев для тестирования непосредственно алгоритма сортировки Таноса.
 * Входные данные формируются прямой инициализацией массива значениями либо с помощью генератора случайных массивов.
 * В некоторых случаях для получения ожидаемого результата используется метод сортировки Arrays.sort().
 */
